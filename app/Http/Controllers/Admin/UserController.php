...
class UserController extends Controller
{
    ...
    // This method fetches user data and sends to view
    public function getUsers()
    {
        $users = $this->Users->allUsers(); // ✅ Method from model

        return view('admin.add-properties', ['users' => $users]); // ✅ use lowercase 'users'
    }
    ...
    //  This use For User / Customer Status Change Functions
    public function toggleStatus($id)
    {
        ...
        return redirect()->back()->with('success', 'User status updated and email sent.');
    }
}
