...
<head>
    ...
    <title>Welcome to Travel Bro India – Your Vendor Account is Now Active!</title>
    <style type="text/css">
        a,
        a[href],
        a:hover,
            ...
            <tbody>
                <tr>
                    <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px;  " width="596">
                        <h1 style=" font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #1d6597; ">
                            Dear {{ $data['name'] }},
                        </h1>
                        <p style=" font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #919293; ">
                            Thank you for registering with Travel Bro India. We’re delighted to welcome you as a valued hotel partner on our platform.<br>
                            We’re pleased to inform you that your vendor account has been successfully activated. You can now log in and begin listing your property, managing room availability, and receiving booking inquiries directly from our growing community of travelers across India and beyond.</p>
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td style=" width: 596px; vertical-align: top;padding-left: 30px; padding-right: 30px; padding-bottom: 0;" width="596">
                        <h1 style=" font-size: 20px;line-height: 24px;font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #1d6597; margin-bottom: 0; ">
                            As a registered hotel/vendor, you can now
                        </h1>
                    </td>
                </tr>
            </tbody>
            ...
            <tbody>
                <tr>
                    <td style=" width: 252px; vertical-align: top; padding-left: 30px;padding-right: 15px; padding-top: 0;text-align: center; " width="252">
                        <p style="  font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif;  font-weight: 400; text-decoration: none; color: #919293; ">
                        <ul>
                            <li>Upload and manage your hotel/property listings</li>
                            <li>Set rates, availability, and special offers</li>
                            <li>Receive and respond to direct booking requests</li>
                            <li>Track performance and get dedicated partner support</li>
                        </ul>
                        <br>
                        Our platform is designed to help you maximize visibility, boost bookings, and manage everything from one easy-to-use dashboard.
                        <br>
                        To get started, simply log in with the credentials you used during registration. If you require any assistance or have questions at any stage, our support team is here to help.
                ...
                <tr>
                    <td style=" width: 252px; vertical-align: top; padding-left: 30px; padding-right: 15px;  padding-top: 0;  padding-bottom: 30px; text-align: center; " width="252">
                        <a style=" font-size: 15px; line-height: 24px; font-weight: 400; text-decoration: none; color: #919293; ">
                            ...
                            <p>
                                Thank you for choosing Travel Bro India. We look forward to a successful partnership with you.
                                <br>
                                Warm regards, <br>
                                Team Travel Bro India <br>
                                Your Partner in Growth <br>
