...
<head>
    ...
    <title>Travel Bro India | Dashboard - Edit Customers</title>
        ...
        <div class="content-wrapper" style="min-height: 759px;">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <form class="svform" action="{{ route('admin.edit-customer',$users->id) }}" id="add_customer" method="post" enctype="multipart/form-data" name="add-customer" accept-charset="UTF-8" novalidate="novalidate">
                                @method('put')
                                @csrf
                                <div class="box-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="@error('firstname') is-invalid @enderror form-control" name="firstname" id="first_name" value="{{ old('firstname', $users->firstname) }}" placeholder="First Name">
                                            @error('firstname')
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="lastname" value="{{ old('lastname', $users->lastname) }}" id="last_name" placeholder="Last Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if($users->image != "")
                                            <img src="{{ asset('Uploads/user/'.$users->image) }}" alt="{{ $users->user_id }}" style="width: 80px; margin-top:10px ;">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="@error('email') is-invalid @enderror form-control error" name="email" id="email" value="{{ old('email' , $users->email )}}" placeholder="exaple@gmail.com">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="intl-tel-input allow-dropdown separate-dial-code iti-sdc-2">
                                                ...
                                                <input type="tel" class="@error('phone') is-invalid @enderror form-control" id="phone" name="phone" autocomplete="off" value="{{ old('phone', $users->phone) }}" placeholder="882245-8954">
                                            </div>
                                            @error('phone')
                                            <p class="invalid-feedback text-white">{{ $message }}</p>
                                            @enderror
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="role" id="role">
                                                ...
                                                <option value="Vendor" {{ old('role', $users->role ?? '') == 'Vendor' ? 'selected' : '' }}>
                                                    Vendor</option>
                                                <option value="Customer" {{ old('role', $users->role ?? '') == 'Customer' ? 'selected' : '' }}>
                                                    Customer</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="status" id="status">
                                                <option value="Active" {{ old('status', $users->status ?? '') == 'Active' ? 'selected' : '' }}>
                                                    Active</option>
                                                <option value="Inactive" {{ old('status', $users->status ?? '') == 'Inactive' ? 'selected' : '' }}>
                                                    Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" name="submit" id="submitBtn">Update</button>
