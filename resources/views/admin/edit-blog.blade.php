                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ route('admin.edit-blog', $blog->id) }}" id="add_page" method="post" accept-charset='UTF-8' enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="author_name" class="form-control @error('author_name') is-invalid @enderror">
                                                <option value="Admin" {{ $blog->author_name == 'Admin' ? 'selected' : '' }}>Admin</option>
                                                <option value="Avni" {{ $blog->author_name == 'Avni' ? 'selected' : '' }}>Avni</option>
                                                <option value="Kanish" {{ $blog->author_name == 'Kanish' ? 'selected' : '' }}>Kanish</option>
                                                <option value="Content Writer" {{ $blog->author_name == 'Content Writer' ? 'selected' : '' }}>Content Writer</option>
                                            </select>
                                            @error('author_name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control @error('blog_name') is-invalid @enderror" name="blog_name" value="{{ old('blog_name', $blog->blog_name) }}" required>
                                            @error('blog_name')
                                            <p class="invalid-feedback text-red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if ($blog->image)
                                            <img src="{{ asset('Uploads/blog/' . $blog->image) }}" alt="" width="80" style="margin-top:10px;">
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control @error('alt_tag') is-invalid @enderror" name="alt_tag" id="page_url" value="{{ old('alt_tag', $blog->alt_tag) }}">
                                            @error('alt_tag')
                                            <p class="invalid-feedback text-red">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="ckeditor" id="content" name="content" rows="10" cols="80" required>{{ old('content', $blog->content) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="meta_title" value="{{ old('meta_title', $blog->meta_title) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="meta_keyword" value="{{ old('meta_keyword', $blog->meta_keyword) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="meta_description" class="form-control" cols="30" rows="10">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="{{ route('admin.manage-blog') }}" class="btn btn-danger btn-sm">Cancel</a>
                                </div>
                            </form>
