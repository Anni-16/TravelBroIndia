<aside class="main-sidebar" style="padding-top:80px;">
  <section class="sidebar" style="height: auto;">
    <ul class="sidebar-menu">
      ...
      <li class="{{ request()->routeIs('admin.manage-user') ? 'active' : '' }}">
        <a href="{{ route('admin.manage-user') }}">
          <i class="fa fa-users"></i><span>Manage Users</span>
        </a>
      </li>

      <li class="{{ request()->routeIs('admin.manage-listing') ? 'active' : '' }}">
        <a href="{{ route('admin.manage-listing') }}">
          <i class="fa fa-list"></i><span>Manage Listings</span>
        </a>
      </li>

      <li class="treeview {{ request()->routeIs('admin.amenities-type', 'admin.amenities','admin.property-category') ? 'active' : '' }}">
        <a href="#">
          <i class="fa fa-check-circle"></i> <span>Manage Property</span>
          <i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
          <li class="{{ request()->routeIs('admin.property-category') ? 'active' : '' }}">
            <a href="{{ route('admin.property-category') }}">Property Category</a>
          </li>
          <li class="{{ request()->routeIs('admin.rooms-type') ? 'active' : '' }}">
            <a href="{{ route('admin.rooms-type') }}">Rooms Types</a>
          </li>
          <li class="{{ request()->routeIs('admin.amenities-type') ? 'active' : '' }}">
            <a href="{{ route('admin.amenities-type') }}">Amenities Category</a>
          </li>
          <li class="{{ request()->routeIs('admin.amenities') ? 'active' : '' }}">
            <a href="{{ route('admin.amenities') }}"><span>Amenities</span></a>
          </li>
        </ul>
      </li>
      ...
      <li class="{{ request()->routeIs('admin.manage-blog') ? 'active' : '' }}">
        <a href="{{ route('admin.manage-blog') }}">
          <i class="fa fa-commenting"></i><span> Manage Blog</span>
        </a>
      </li>
      ...
      <!-- <li class=""><a href="manage-exprience.html"><i class="fa fa-list"></i><span>Manage Experience</span></a></li> -->
      ...
      <!-- <li class=""><a href="user-reviews.html"><i class="fa fa-commenting"></i><span>User Reviews</span></a></li> -->

      <!-- <li class=""><a href="site-testimonials.html"><i class="fa fa-list-alt" aria-hidden="true"></i><span>Site
      ...
      <li class="treeview {{ request()->routeIs('admin.social-media', 'admin.manage-cms') ? 'active' : '' }}">
        <a href=" ">
          <i class="fa fa-search-plus"></i> <span> Manage Website Settings</span><i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
          <li class="{{ request()->routeIs('admin.manage-cms') ? 'active' : '' }}">
            <a href="{{ route('admin.manage-cms') }}" data-group="social_links">Manage CMS</a>
          </li>
          <li class="{{ request()->routeIs('admin.social-media') ? 'active' : '' }}">
            <a href="{{ route('admin.social-media') }}" data-group="social_links">Social Media Links</a>
          </li>
        </ul>
      </li>

      <!-- <li class="">
        <a href="meta.html" data-group="metas"><i class="fa fa-search-plus"></i> <span>SEO Settings</span></a>
      </li>
-->
