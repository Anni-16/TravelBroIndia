...
<head>
    ...
    <title>Travel Bro India | Dashboard - Add Rooms Type </title>
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Add Rooms Type</h3>
                            </div>

                            <form class="form-horizontal" action="{{ route('admin.add-rooms-type') }}" id="add_rooms" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="box-body">
                                ...
                                <div class="box-footer">
                                    <a href="{{ route('admin.property-category') }}" class="btn btn-danger btn-sm">Back</a>
