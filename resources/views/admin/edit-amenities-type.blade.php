...
<head>
    ...
    <title>Travel Bro India | Dashboard - Edit Amenities Type </title>
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Edit Amenity Categories</h3>
                            </div>
                            <!-- form start -->
                            <form class="form-horizontal" action="{{ route('admin.edit-amenities-type', $amenitiestype->id) }}" id="add_amenity" method="post" name="add_amenity" accept-charset="UTF-8" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class=" @error('name') is-invalid @enderror form-control" value="{{ old('name',$amenitiestype->name) }}" name="name" id="name">
                                            @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select class="form-control" name="status" id="sv_en_lang_status">
                                                <option value="1" {{ old('status', $amenitiestype->status ?? '') == '1' ? 'selected' : '' }}>Active</option>
                                                <option value="0" {{ old('status', $amenitiestype->status ?? '') == '0' ? 'selected' : '' }}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
