...
<head>
    ...
    <title> Awesome | Dashboard - Amentites Types </title>
                        ...
                        <div class="box box_info">
                            <div class="box-header">
                                ...
                                <div class="pull-right"><a class="btn btn-primary"
                                        href="{{ route('admin.add-amenities-type') }}">Add
                                        Amenity Type</a></div>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $amenitiestypes->description }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.edit-amenities-type', $amenitiestypes->id) }}"
                                                            class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>
                                                        <a href="#" class="btn btn-xs svbtn delete-warning"
                                                            data-id="{{ $amenitiestypes->id }}">
                                                            <i class="fa fa-trash"></i>
                                                        </a>
                                                        <form id="delete-form-{{ $amenitiestypes->id }}"
                                                            action="{{ route('admin.delete-amenities-type', $amenitiestypes->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
