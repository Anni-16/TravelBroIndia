        ...
        <div class="container-fluid">
            <div class="row">
                <div class="login-form-sec">
                    ...
                    <img src="{{ asset('masster-admin-design/images/admin_login_img.png') }}" alt="" style="width: 100%; height:auto; margin-top:100px;">
                    
                    <div class="admin-login-content">
                        <div class="admin-login-form">
                            <div class="text-center">
                                <a href="#"><img src="{{ asset('front-end/assets/img/Travel-bro1.png') }}" alt="logo" style="width: 100px;"></a>
                            </div>
                            <h2 class="text-center welcome-txt">Welcome Travel bro India </h2>
                            <h3 class="text-center welcome-txt" style="margin: 0px;">Admin Panel</h3>
                            ...
                            <form action="{{ route('admin.admin-login') }}" method="post" id="admin_login">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="password-wrapper ">
                                        <input type="password" id="password-field" name="password" class="form-control" style="padding: 0 20px;" placeholder="Password" />
