                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <!-- form start -->
                            <form class="form-horizontal" action="{{route('admin.add-amenities') }}" id="add_amen"
                                method="post" name="add_amen" accept-charset="UTF-8" enctype="multipart/form-data">
                                @csrf
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @enderror form-control" value="{{ old('name') }}" name="name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <textarea id="description" name="description" rows="10" cols="50"
                                                class="@error('name') is-invalid @enderror form-control">{{ old('description') }}</textarea>
                                            @error('description')
                                            <p class="invalid-feedback text-white">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="control-label col-sm-3">Symbol<span
                                                class="text-danger">*</span></label>
                                        <div class="col-sm-6">
                                            <div class="input-group iconpicker-container">
                                                <input data-placement="bottomRight"
                                                    class="form-control "
                                                    name="icon" value="{{ old('icon') }}" type="text">                                                
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select name="amenities_type_id" class="form-control" id="type_id" required="">
                                                <option value="1"> Common Amenities</option>
                                                <option value="2"> Safety Amenities</option>
                                            </select>
                                        </div>
                                    </div>
