                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <!-- form start -->
                            <form class="form-horizontal" action="{{route('admin.add-amenities') }}" id="add_amen" method="post" name="add_amen" accept-charset="UTF-8" enctype="multipart/form-data">
                                @csrf
                                <div class="box-body">
                                    <div class="form-group row">
                                        <label for="type_id" class="control-label col-sm-3">Amenities Category <span class="text-danger">*</span></label>
                                        <div class="col-sm-6">
                                            <select name="amenities_type_id" class="form-control" id="type_id" required>
                                                <option value="">-- Select Category --</option>
                                                @foreach($amenitiesTypes as $type)
                                                <option value="{{ $type->id }}"
                                                    {{ (old('amenities_type_id', $amenitie->amenities_type_id ?? '') == $type->id) ? 'selected' : '' }}>
                                                    {{ $type->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @enderror form-control" value="{{ old('name') }}" name="name" placeholder="" id="title">
                                            @error('name')
