...
<head>
    ...
    <title>Travel Bro India | Dashboard - Manage user</title>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div class="pull-right"><a class="btn btn-primary" href="{{ route('admin.add-customer') }}">Add
                                        Customer</a>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-hover dt-responsive svusertable dataTable no-footer dtr-inline" id="myTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTableBuilder_info" style="width: 100%;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style="width: 133px;"> Full Name</th>
                                                    <th style="width: 122px;">Phone</th>
                                                    <th style="width: 202px;">Email</th>
                                                    <th style="width: 202px;">Role</th>
                                                    <th style="width: 90px;">Status </th>
                                                    <th style="width: 179px;"> Created At</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        @if($user->image != "")
                                                        <img src="{{ asset('Uploads/user/'.$user->image) }}" alt="{{ $user->user_id }}" style="width: 40px;">
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>{{ $user->role }}</td>
                                                    <td>
                                                        <form action="{{ route('admin.toggle-status', $user->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('PATCH')
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.edit-customer', $user->id) }}" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>
                                                        <a class="btn btn-xs svbtn delete-warning" data-id="{{ $user->id }}" data-toggle="modal" data-target="#deleteModal">
                                                            <i class="fa fa-trash"></i>
                                                        </a>

                                                        <form id="delete-form-{{ $user->id }}" action="{{ route('admin.delete-customer', $user->id) }}" method="POST" style="display: none;">
                                                            @csrf
                                                            @method('delete')
                                                        </form>
                                                    </td>
