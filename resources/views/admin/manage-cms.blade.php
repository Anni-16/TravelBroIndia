...
<head>
    ...
    <title>Travel Bro India | Dashboard - Manage CMS</title>
                                        ...
                                        <table class="table table-hover dt-responsive svusertable dataTable no-footer dtr-inline" id="myTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTableBuilder_info" style="width: 100%;">
                                            ...
                                            <tbody>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>about-us</td>
                                                    <td>
                                                        <a href="" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>
                                                    </td>
                                                </tr>
                                                <tr role="row" class="odd">
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td style="text-align: left;">Privacy & Policies</td>
                                                    <td>about-us</td>
                                                    <td>
                                                        <a href="" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>
                                                    </td>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td style="text-align: left;">Refund & Cancel</td>
                                                    <td>about-us</td>
                                                    <td>
                                                        <a href="" class="btn btn-xs svbtn"><i class="fa fa-pencil"></i></a>
                                                    </td>
