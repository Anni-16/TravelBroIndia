...
<head>
    ...
    <title>Travel Bro India | Dashboard - Add Property Category </title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <form class="form-horizontal" action="{{ route('admin.add-property-category') }}" id="add_property" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="box-body">
