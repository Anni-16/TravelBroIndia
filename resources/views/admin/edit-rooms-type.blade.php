...
<head>
    ...
    <title>Travel Bro India | Dashboard - Edit Rooms Type </title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-header with-border">
                                <h3 class="box-title">Edit Rooms Type</h3>
                            </div>
                            <!-- form start -->

                            <form class="form-horizontal" action="{{ route('admin.edit-rooms-type', $roomtype->id) }}" id="edit_property" method="post" name="edit_property" accept-charset="UTF-8" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class=" @error('name') is-invalid @enderror form-control" value="{{ old('name',$roomtype->name) }}" name="name" id="name">
                                            @error('name')
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="{{ route('admin.rooms-type') }}" class="btn btn-danger btn-sm">
                                        Cancel
                                    </a>
