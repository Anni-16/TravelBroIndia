...
<head>
    ...
    <title> Awesome | Dashboard - Add Customers</title>
        ...
        <div class="content-wrapper" style="min-height: 759px;">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            <form class="svform" action="{{ route('admin.add-customer') }}" id="add_customer"
                                method="post" enctype="multipart/form-data" name="add-customer" accept-charset="UTF-8"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"
                                                ...
                                                name="firstname" id="first_name" value="{{ old('firstname') }}"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="lastname"
                                                value="{{ old('lastname') }}" id="last_name" placeholder="Last Name">
                                        </div>
                                    </div>
