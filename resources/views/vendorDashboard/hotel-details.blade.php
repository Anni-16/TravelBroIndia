...
<body>
 ...
 <div class="col-lg-12 mb-2">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="" id="about_place" cols="50" rows="10"
                                                                    class="form-control"  
                                                                    ></textarea>
                                                                     <div class="validation-message" id="about_place_error"></div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea name="" id="about_place2" cols="50" rows="10"
                                                                    class="form-control"  
                                                                    ></textarea>
                                                                      <div class="validation-message" id="about_place2_error"></div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="mb-3">
                                                                <label class="text-label form-label">Guest
                                                                    Access*</label>
                                                                <textarea name="" id="guest" cols="50" rows="10"
                                                                    class="form-control"  
                                                                    ></textarea>
                                                                       <div class="validation-message" id="guest_error"></div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12 mb-2">
                                                            <div class="mb-3">
                                                                <label class="text-label form-label">Other Things to
                                                                    Note*</label>
                                                                <textarea name="" id="others" cols="50" rows="10"
                                                                    class="form-control" 
                                                                    ></textarea>
  ...
  <script src="{{ asset('VendorDashboard/vendor/global/global.min.js')}}"></script>
    ...
    <script>
document.getElementById('third-form').addEventListener('submit', function(e) {
    e.preventDefault();

    let isValid = true;

    const fields = [
        { id: 'about_place', errorId: 'about_place_error', label: 'Please Enter About Place' },
        { id: 'about_place2', errorId: 'about_place2_error', label: 'Please Enter Place is great for' },
        { id: 'guest', errorId: 'guest_error', label: 'Please Enter Guest Access' },
        { id: 'others', errorId: 'others_error', label: 'Please Enter Other Things' },
    ...
    if (isValid) {
        window.location.href = "{{ route('hotel-location') }}";
    }
});

// Back redirect
document.getElementById('back').addEventListener('click', function() {
    window.location.href = "my-hotel-description.html";
});
</script>
