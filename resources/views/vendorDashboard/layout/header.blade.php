	...
	<div class="nav-header">
		<a href="{{ route('vendorDashboard.vendorDashboard') }}" class="brand-logo">
				...
				<div class="collapse navbar-collapse justify-content-between">
					...
					<ul class="navbar-nav header-right">
						...
						<li class="nav-item dropdown header-profile">
							<a class="btn btn-outline-primary btn-rounded mt-1 px-5" href="{{ route('vendorDashboard.hotel-listing') }}">
								Add Your Hotel
							</a>
						</li>
						...
						<li class="nav-item dropdown header-profile">
							<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
								<img src="{{ asset('Uploads/user/'.session('userData')->image) }}" width="20" alt="" />
							</a>
							<div class="dropdown-menu dropdown-menu-end">
								<a href="{{ route('vendorDashboard.edit-profile') }}" class="dropdown-item ai-icon">
