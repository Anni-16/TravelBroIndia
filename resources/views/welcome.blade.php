                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="flight_categories_search">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" id="oneway-tab" data-bs-toggle="tab" data-bs-target="#oneway_flight" type="button" role="tab" aria-controls="oneway_flight" aria-selected="true">Hotels</button>
                                                </li>
                    ...
                    <div class="five_about_left">
                        <div class="section_heading_five">
                            ...
                            <p>Welcome to Travel Bro: your partner in unforgettable journey
                                We're passionate about creating unique and memorable journeys that go beyond the normal, exploring new cultures, welcoming the unexpected, and creating unforgettable memories. Founded on March 3rd, 2025 our team of committed travel experts has spent years exploring the world, sharing knowledge and expertise to design itineraries that resonate with your passion. Whether you're looking for a relaxing getaway or an adventure-filled trip, we've got the perfect itinerary for you. By choosing Travel Bro, you will experience local expertise, extraordinary service, cost-effective and eco-tourism practices that support local communities and diminish environmental impact.
                            </p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_heading_seven">
                        ...
                        <a href="#">See all<img src="{{ asset('front-end/assets/img/icon/list-arrow.png') }}" alt="icon"></a>
                    </div>
                    <div class="trending_destinations_wrapper">
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/bali.png') }}" alt="img" style="height: 105px; object-fit:cover;"></a>
                            </div>
                            <h3>Dehradun</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#">
                                    <img src="{{ asset('front-end/assets/img/city-img/Puri.png') }}" alt="img"></a>
                            </div>
                            <h3>Puri</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/goa.png') }}" alt="img"></a>
                            </div>
                            <h3>Goa</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{  asset('front-end/assets/img/city-img/ooty.png') }}" alt="img"></a>
                            </div>
                            <h3>Ooty</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/shimla.png') }}" alt="img"></a>
                            </div>
                            <h3>Shimla</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/manali.png') }}" alt="img"></a>
                            </div>
                            <h3>Manali</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/Mysore.png') }}" alt="img"></a>
                            </div>
                            <h3>Mysore</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/Amritsar.png') }}" alt="img"></a>
                            </div>
                            <h3>Amritsar</h3>
                        </div>
                        <div class="trending_item">
                            <div class="treding_img">
                                <a href="#"><img src="{{ asset('front-end/assets/img/city-img/Pokhara.png') }}" alt="img"></a>
                            </div>
                            <h3>Pokhara</h3>
                        </div>
                    </div>
                    ...
                    <div class="promotional_tour_slider owl-theme owl-carousel dot_style">
                        <div class="theme_common_box_two img_hover">
                            <div class="theme_two_box_img">
                                <a href="my-my-hotel-details.html"><img src="{{ asset('front-end/assets/img/my-images/hotel-1.jpeg') }}" alt="img"></a>
                        ...
                        <div class="theme_common_box_two img_hover">
                            <div class="theme_two_box_img">
                                <a href="my-hotel-details.html"><img src="{{ asset('front-end/assets/img/my-images/hotel-1.jpeg') }}" alt="img"></a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                                            <div class="amazing_place_boxed">
                                                <a href="my-hotel-details.html">
                                                    <div class="amazing_place_img padding_img">
                                                        <img src="{{ asset('front-end/assets/img/home-eight/amazing-place/am-place-5.png') }}" alt="img">
                                                    </div>
                                                    <div class="amazing_place_box_content">
                                                        <div class="amazing_place_inner_content">
                                                            <div class="rating_outof">
                                        ...
                                        <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                                            <div class="amazing_place_boxed">
                                                <a href="my-hotel-details.html">
                                                    <div class="amazing_place_img">
                                                        <img src="{{ asset('front-end/assets/img/home-eight/amazing-place/am-place-6.png') }}" alt="img">
                                                    </div>
                                                    <div class="amazing_place_box_content">
                                                        <div class="amazing_place_inner_content">
                                                            <div class="rating_outof">
                    ...
                    <div class="theme_nav_tab">
                        <nav class="theme_nav_tab_item">
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-nepal-tab" data-bs-toggle="tab" data-bs-target="#nav-nepal" type="button" role="tab" aria-controls="nav-nepal" aria-selected="true">Mumbai</button>
                                <button class="nav-link" id="nav-malaysia-tab" data-bs-toggle="tab" data-bs-target="#nav-malaysia" type="button" role="tab" aria-controls="nav-malaysia" aria-selected="false">Ooty</button>
                                <button class="nav-link" id="nav-indonesia-tab" data-bs-toggle="tab" data-bs-target="#nav-indonesia" type="button" role="tab" aria-controls="nav-indonesia" aria-selected="false">Delhi</button>
                                <button class="nav-link" id="nav-turkey-tab" data-bs-toggle="tab" data-bs-target="#nav-turkey" type="button" role="tab" aria-controls="nav-turkey" aria-selected="false">Jaipur</button>
                                <button class="nav-link" id="nav-china-tab" data-bs-toggle="tab" data-bs-target="#nav-china" type="button" role="tab" aria-controls="nav-china" aria-selected="false">Manali</button>
                                <button class="nav-link" id="nav-darjeeling-tab" data-bs-toggle="tab" data-bs-target="#nav-darjeeling" type="button" role="tab" aria-controls="nav-darjeeling" aria-selected="false">Darjeeling</button>
                                <button class="nav-link" id="nav-italy-tab" data-bs-toggle="tab" data-bs-target="#nav-italy" type="button" role="tab" aria-controls="nav-italy" aria-selected="false">Goa</button>
                            </div>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="tab-content" id="nav-tabContent1">
                        <div class="tab-pane fade show active" id="nav-nepal" role="tabpanel" aria-labelledby="nav-nepal-tab">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                                            <a href="top-destinations.html"><img src="{{ asset('front-end/assets/img/destination/destination-small1.png') }}" alt="img"></a>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                                            <a href="top-destinations.html"><img src="{{ asset('front-end/assets/img/destination/destination-small2.png') }}" alt="img"></a>
                                        </div>
                                        <div class="tab_destinations_conntent">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                                            <a href="top-destinations.html"><img src="{{ asset('front-end/assets/img/destination/destination-small3.png') }}" alt="img"></a>
                                        </div>
                                        <div class="tab_destinations_conntent">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                                            <a href="top-destinations.html"><img src="{{ asset('front-end/assets/img/destination/destination-small4.png') }}" alt="img"></a>
                                        </div>
                                        <div class="tab_destinations_conntent">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                                            <a href="top-destinations.html"><img src="{{  asset('front-end/assets/img/destination/destination-small5.png') }}" alt="img"></a>
                                        </div>
                                        <div class="tab_destinations_conntent">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                                            <a href="top-destinations.html"><img src="{{ asset('front-end/assets/img/destination/destination-small6.png') }}" alt="img"></a>
                                        </div>
                                        <div class="tab_destinations_conntent">
                        ...
                        <div class="tab-pane fade" id="nav-darjeeling" role="tabpanel" aria-labelledby="nav-darjeeling-tab">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="tab_destinations_boxed">
                                        <div class="tab_destinations_img">
                        ...
                        <div class="common_card_four">
                            <div class="news_card_four_wrapper">
                                ...
                                <div class="news_card_four_heading">
                                    ...
                                    <ul>
                                        <li> {{ $blog->formatted_date }}<i class="fas fa-circle"></i></li>
